	...
	function z(a) {
		...
		if(d != -1) {
			var c = a.substring(0, d) || "*",
				...
				f = [];
			o(document.getElementsByTagName(c), function() {
	...
	function n(a, d, c) {
		...
		f._fireEvent = function(g) {
			...
			if(!(q == "onLoad" && k != "player")) {
				...
				if(q == "onContextMenu") o(c.contextMenu[k], function(N, K) {
					K.call(f)
				});
...
(function(B, y) {
	...
	function s() {
		o(y.getElementsByTagName("video"), function(i) {
			...
			if(i.canPlayType)
				...
				else o(i.getElementsByTagName("source"), function(n) {
	...
	y.createElement("video").canPlayType || o(["abbr", "article", "aside", "audio", "canvas", "details", "figcaption", "figure", "footer", "header", "hgroup", "mark", "menu", "meter", "nav", "output", "progress", "section", "summary", "time", "video", "source"], function(i) {
		y.createElement(i)
	});
	var E = "";
	o(y.getElementsByTagName("script"), function(i) {
		i = i.src;
	...
	s.createVideoFallback = function(i) {
		...
		e || o(i.getElementsByTagName("source"), function(c) {
